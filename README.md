...
**EP-0** (โครงโปรเจกต์) และ **CI แบรนด์โอกะหมู** เสร็จแล้ว กำลังทำ **EP-3** (หน้าเมนู)

| Route | หน้า |
| --- | --- |
| `/r/:storeSlug` | หน้าร้าน + เมนู (รองรับ `?table=12` จาก QR) |
| `/design-system` | Design System — สี ตัวพิมพ์ คอมโพเนนต์ |

ตะกร้าและ flow สั่งซื้อจะมาใน EP-4/EP-5
